...
function selectTestMode(e) {
    ...
    if (e) t.classList.remove("ep-settings-prod-mode-alert"),
        t.classList.add("ep-settings-test-mode-alert"),
        ...
        t.classList.remove("ep-settings-test-mode-alert"),
...
function mpShowMessage(e, t, n) {
    ...
    switch (n) {
        ...
        case"payment":
            ...
            break;
        case"test_mode":
            a = document.querySelector(".ep-message-test-mode"), o = document.querySelector(".ep-heading-test-mode");
            break;
        default:
            a = "", o = ""
    }
