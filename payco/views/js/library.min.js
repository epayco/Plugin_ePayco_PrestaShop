...
(function () {
    var e, t, r, o;
    languages = new Array, base_url_pre = "https://eks-subscription-api-lumen-service.epayco.io/", languages.es = {
        errors: [{
            type: 101,
        ...
        setPublicKey: function (e) {
            ...
            objectKeys: function (e) {
                ...
                try {
                    ...
                    let r = base_url_pre + "token/encrypt";
                ...
                try {
                    const t = {values: e};
                    let r = base_url_pre + "token/tokenize";
                    const o = await fetch(r, {
                        method: "POST",
                        headers: {"Content-Type": "application/json"},
                        body: JSON.stringify(t)
