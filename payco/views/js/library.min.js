...
(function () {
    var e, t, r, o;
    languages = new Array, base_url_pre = "https://eks-apify-service.epayco.io/", languages.es = {
        errors: [{
            type: 101,
        ...
        let o = ePaycoSubscription.getLanguage();
        if ("es" == o || "en" == o) var n = languages[ePaycoSubscription.getLanguage()].errors, a = e; else {
            var i;
        ...
        return e
    }, r = e("epayco_publish_key"), o = e("epayco_language"), window.ePaycoSubscription || (window.ePaycoSubscription = {
        setPublicKey: function (e) {
            ...
            objectKeys: function (e) {
                ...
                try {
                    const t = {public_key: ePaycoSubscription.getPublicKey(), session: e};
                    let r = "https://eks-apify-service.epayco.io/token/encrypt";
                ...
                try {
                    const t = {values: e};
                    let r = "https://eks-apify-service.epayco.io/token/tokenize";
                    const o = await fetch(r, {
                        method: "POST",
                        headers: {"Content-Type": "application/json"},
                        body: JSON.stringify(t)
                ...
                var r = [];
                const o = ePaycoSubscription.getPublicKey();
...
(function () {
    ...
    }, ePaycoSubscription.card.resultExpirationDate = function (e) {
...
(function () {
    ePaycoSubscription.token = {}, ePaycoSubscription.token.create = async function (e, a) {
        if ("object" == typeof (i = ePaycoSubscription._utils.parseForm(e)) && ePaycoSubscription._utils.objectKeys(i).length > 0) if (i.card) {
            var r, t, c, d, i, o,
                l = i.card.date_exp.length > 0 ? ePaycoSubscription.card.resultExpirationDate(i.card.date_exp) : i.card.exp_month + "/" + i.card.exp_year,
                n = i.card.date_exp.length > 0 ? ePaycoSubscription.card.validateExpirationDate(i.card.date_exp) : ePaycoSubscription.card.validateExpirationDate(i.card.exp_month, i.card.exp_year);
            r = {
                customer: [{
                    type: "name",
                    value: i.card.name,
                    required: !0,
                    validate: ePaycoSubscription.card.name(i.card.name)
                }, {
                    type: "email",
                    value: i.card.email,
                    required: !0,
                    validate: ePaycoSubscription.card.email(i.card.email)
                }, {
                    type: "number",
                    value: i.card.number.replace(/ /g, ""),
                    required: !0,
                    validate: ePaycoSubscription.card.validateNumber(i.card.number.replace(/ /g, ""))
                }, {
                    type: "cvc",
                    value: i.card.cvc,
                    required: !0,
                    validate: ePaycoSubscription.card.validateCVC(i.card.cvc)
                }, {type: "date_exp", value: l, required: !0, validate: n}]
            }, o = null == localStorage.getItem("keyUserIndex") ? localStorage.setItem("keyUserIndex", ePaycoSubscription._utils.createGuid()) : localStorage.getItem("keyUserIndex");
            ...
            (t = await ePaycoSubscription._utils.createTokenEncrypt(o)).status ? (c = t.data.token, d = ePaycoSubscription._utils.createCreditCard(r, c), a(await ePaycoSubscription._utils.createTokenRequest(d))) : a(t)
        } else getError(101)
    }
}).call(this);