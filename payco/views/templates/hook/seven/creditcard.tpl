...
<form id="ep_creditcard_checkout"  method="post" action="{$redirect|escape:'htmlall':'UTF-8'}">
    <div class='ep-checkout-container'>
        <div class="ep-checkout-creditcard-container" margin: auto;">
            <div class="ep-checkout-creditcard-content">
                <div class="ep-checkout-creditcard-test-mode" style="background-color: 'blue' ">
                    {if $payment_method_info["test"]}
                        ...
                        <div class="ep-test-mode-credit-card" style="background-color: #E8F4FD; border-radius: 8px; padding: 15px; margin-bottom: 15px; margin-top: 10px;">
                ...
                <div style="margin-left: -18px; font-weight: bold; display: flex; align-items: center;">
                    <svg width="28" height="28" style="margin-top: 14px; margin-left: 11px;" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p style="margin-left: -8px;color: black; font-weight: bold !important;">{l s='Datos de la tarjeta' mod='payco'}</p>
                </div>
                <div id="ep-custom-checkout-form-container" style="    right: 10px !important;
                    width: 579px;
                    position: relative;
                    margin-bottom: 28px;
                        margin-top: -15px;">
                ...
                <div style="font-weight: bold; display: flex;align-items: center; margin-left: -5px;">
                    <svg width="28" height="28" style="margin-top: 12px; margin-left: 2px;" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p style="margin-left: -6px; color:black; font-weight: bold !important;">{l s='Datos del cliente' mod='payco'}</p>
                </div>
                <div id="ep-custom-checkout-form-container" style="    
                    width: 579px;
                    position: relative;
                    margin-bottom: 28px;">
            ...
            <div style="width: 493px !important;
    margin-left: 0px;
    margin-top: 32px;">
...
<script type="text/javascript" src="{$module_dir|escape:'htmlall':'UTF-8'}views/js/library.min.js"/>
