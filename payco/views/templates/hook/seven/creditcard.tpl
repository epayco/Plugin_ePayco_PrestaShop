    ...
    <div class='ep-checkout-container'>
        <div class="ep-checkout-creditcard-container" style="max-width: 452px;margin: auto;">
            <div class="ep-checkout-creditcard-content">
                <div class="ep-checkout-creditcard-test-mode">
                    {if $payment_method_info["test"]}
                        <div class="ep-test-mode-credit-card">
                            <img src="{$module_dir|escape:'htmlall':'UTF-8'}views/img/icon-info.png"style="/* margin-top: 19px; */font-weight: bold;display: flex;align-items: center;width: 35px;height: 25px;margin: 15px 5px;" >
                            <div style="display: grid;grid-template-rows: repeat(2, 1fr);gap: 15px;">
                                <div class="ep-test-mode-credit-card-p" style="margin: -17px 32px -16px; margin-top: -39px;">
                                    <p>Por favor, utiliza la siguiente información de tarjeta de prueba en modo de prueba:</p>
                                    <p style="font-weight: bold;color:black;margin: 7px 0px;">Número: 4575 6231 8229 0326</p>
                                    <div style="width: 50%;display: grid;grid-template-columns: repeat(3, 1fr);gap: 0px;padding: 0px;margin: 3px 5px -6px;">
                ...
                <div style="margin-top: 10px;font-weight: bold;display: flex;align-items: center;margin-left: -23px;">
