...
<form id="ep_creditcard_checkout"  method="post" action="{$redirect|escape:'htmlall':'UTF-8'}">
    <div class='ep-checkout-container'>
        <div class="ep-checkout-creditcard-container" style="width: 100%;">
            <div class="ep-checkout-creditcard-content">
                ...
                <div style="font-weight: bold; display: flex; align-items: center; gap: 8px;">
                    <svg width="28" height="28" style="flex-shrink: 0;" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p style="color: black; font-weight: bold !important;">{l s='Datos de la tarjeta' mod='payco'}</p>
                </div>
                <div id="ep-custom-checkout-form-container" style="width: 100%; position: relative; margin-bottom: 28px; margin-top: -15px;">
                ...
                <div style="font-weight: bold; display: flex; align-items: center; gap: 8px;">
                    ...
                    <p style="color:black; font-weight: bold !important;">{l s='Datos del cliente' mod='payco'}</p>
                </div>
                <div id="ep-custom-checkout-form-container" style="width: 100%; position: relative; margin-bottom: 28px;">
