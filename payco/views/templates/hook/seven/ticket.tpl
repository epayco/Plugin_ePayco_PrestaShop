...
<form id="ep_ticket1_checkout" action="{$redirect|escape:'htmlall':'UTF-8'}" method="post" class="mp-custom-checkout-six">
        ...
        <div class="ep-checkout-ticket-container" style="max-width: 452px;margin: auto;">
            <div class="ep-checkout-ticket-content">
               ...
               <div class="icon-payment-ticket">
                        ...
                        <p class="p1">{l s='Datos de usuario' mod='payco'}</p>
                    </div>
                <div id="ep-custom-checkout-form-container" style="margin: 10px;">
                    ...
                    <div class='ep-checkout-ticket-input-cellphone'>
                        <input-cellphone-epayco
                                label-message="{l s='Telefono' mod='payco'}"
                                helper-message="{l s='Teléfono inválido' mod='payco'}"
