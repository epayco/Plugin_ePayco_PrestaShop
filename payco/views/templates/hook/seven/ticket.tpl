...
<form id="ep_ticket_checkout" method="post" action="{$redirect|escape:'htmlall':'UTF-8'}">
    <div class='ep-checkout-container'>
        <div class="ep-checkout-ticket-container" style="right: 10px !important;
    width: 579px;
    position: relative;
    margin-bottom: 28px;
    margin-top: -15px;">
            <div class="ep-checkout-ticket-content">
                ...
                <div style="margin-top: 10px; font-weight: bold; display: flex; align-items: center;">
                    ...
                    <p style="margin-left: 10px; color:black; font-weight: bold !important;">{l s='Datos del cliente' mod='payco'}</p>
                </div>
                <div id="ep-custom-checkout-form-container" style="margin: 10px;">
                    ...
                    <div class='ep-checkout-ticket-input-cellphone'>
                        <input-cellphone-epayco
                                ...
                                validate=true
                                placeholder="{l s='Número de celular' mod='payco'}"
                        >
                        </input-cellphone-epayco>
                    </div>
                    <div class="ep-checkout-ticket-input-document">
                        <input-document-epayco
                                ...
                                documents='{$documents}'
                                validate=true
                                placeholder="{l s='Número del documento' mod='payco'}"
                        >
                        </input-document-epayco>
                    </div>
            ...
            <div style="style="width: 493px !important;
    margin-left: 0px;
    margin-top: 32px;">
