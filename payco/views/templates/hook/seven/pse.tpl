    ...
    <div class='ep-checkout-container'>
        <div class="ep-checkout-pse-container" style="max-width: 452px;margin: auto;">
            <div class="ep-checkout-pse-content">
                ...
                <div style="margin-top: 10px; font-weight: bold; display: flex; align-items: center; margin: 13px -26px;">
                    <svg width="25" height="25" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p style="margin-left: 10px; color:black; font-weight: bold !important;">{l s='Datos de usuario' mod='payco'}</p>
                </div>
                <div id="ep-custom-checkout-form-container" style="margin: 10px;">
                    <div class="ep-checkout-pse-input-document">
                        <input-name-epayco
                                labelMessage="{l s='Nombre' mod='payco'}"
                                helperMessage="{l s='Nombre inválido' mod='payco'}"
                    ...
                    <div class='ep-checkout-pse-input-cellphone'>
                        <input-address-epayco
                                ...
                                helperMessage="{l s='Dirección inválida' mod='payco'}"
                    ...
                    <div class="ep-checkout-pse-input-document">
                        <input-email-epayco
                                ...
                                helperMessage="{l s='Correo electrónico inválido' mod='payco'}"
                    ...
                    <div class='ep-checkout-pse-input-cellphone'>
                        <input-cellphone-epayco
                                label-message="{l s='Teléfono celular' mod='payco'}"
                                helper-message="{l s='Teléfono celular inválido' mod='payco'}"
                    ...
                    <div class="ep-checkout-pse-person">
                        <input-select-epayco
                                ...
                                label="{l s='Seleccione un tipo de persona' mod='payco'}"
                                optional="false"
                    ...
                    <div class="ep-checkout-pse-input-document">
                        <input-document-epayco
                                ...
                                helper-message="{l s='Documento inválido' mod='payco'}"
                    ...
                    <div class="ep-checkout-pse-input-document">
                        <input-country-epayco
                                label-message="{l s='País' mod='payco'}"
                                helper-message="{l s='Ciudad inválida' mod='payco'}"
                                ...
                                validate=true
                                placeholder="{l s='Ciudad' mod='payco'}"
                        >
                    </div>
                    <div class="ep-checkout-pse-input-document">
                        <input-banks-epayco
                                name="epayco_pse[bank]"
                                label="{l s='Bancos' mod='payco'}"
                                optional="false"
                                options="{$payment_method_info["banks"]}"
                                hidden-id= "hidden-financial-pse"
                                helper-message="{l s='Banco inválido' mod='payco'}"
                                default-option="">
                        </input-banks-epayco>
                    </div>
                </div>
                <!-- NO ELIMINAR CARGANDO -->
