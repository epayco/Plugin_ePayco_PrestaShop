...
<div class="payment-method-wrapper">
    ...
    <form action="{$redirect|escape:'htmlall':'UTF-8'}" method="post"  id="ep_creditcard_checkout">
        <div class='ep-checkout-container'>
            <div class="ep-checkout-creditcard-container" style="max-width: 452px;margin: auto; width: 100%;">
...
{if $public_key != ''}
    <!--<script type="text/javascript" src="https://cms.epayco.co/js/library.js"/>-->
{/if}
