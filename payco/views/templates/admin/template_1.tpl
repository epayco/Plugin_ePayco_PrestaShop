        ...
        <div>
            <div class="ep-settings-header-logo"></div>
                <div class="ep-settings-header-title">
                    <p style="font-weight: 900;color: black;margin:0px 50px !important;font-size: 33px;line-height: 20px">{l s='OPTIMIZA TU TIENDA CON EL' mod='payco'}</p>
                    <p style="font-weight: 900;color: #DF5C1F;margin:15px 50px !important;font-size: 49px">{l s='PLUGIN DE ePayco' mod='payco'}</p>
                    <p class="ep-settings-context">{l s='Facilita los pagos en tu tienda online con el plugin de ePayco.' mod='payco'} <br> 
                    {l s='Con esta integración, podrás ofrecer a tus clientes una experiencia de pago' mod='payco'} <br> 
                    {l s='rápida, segura y sin fricciones.' mod='payco'}</p>
                </div>
        </div>
    </div>
    <p style="font-size: 24px;margin: 10px 0px 10px;font-weight: 700;"> {l s='Configuración' mod='payco'}</p>
